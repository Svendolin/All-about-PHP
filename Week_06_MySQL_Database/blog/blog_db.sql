...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 28. Okt 2021 um 11:43
...
INSERT INTO `blogpost` (`IDblogpost`, `post_title`, `post_created`, `post_author`, `post_category`, `post_shorttext`, `post_longtext`, `post_state`) VALUES
...
(10, 'Der erste Tag im PHP Kurs', '2021-09-23 18:17:12', 'Terry', 'PHP Blog', 'Wir haben vor allem die PHP.INI gesucht ;-)', '<p>Die PHP.INI ist <strong>MEGA </strong>schwierig zu finden.</p>', 0);
...
--
ALTER TABLE `blogpost`
  MODIFY `IDblogpost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
